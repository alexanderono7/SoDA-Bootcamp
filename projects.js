...
Using github API
*/
const GITHUB_USERNAME = "alexanderono7" /**/
...
/*
A JSON file is a with curly braces. Inside those curly braces it has "keys". Each "key" has one "property".
Example:
{
    name: 'obama',
    stars: '4',
...
Name, stars, president = keys
Obama, 4, 44 = properties
*/